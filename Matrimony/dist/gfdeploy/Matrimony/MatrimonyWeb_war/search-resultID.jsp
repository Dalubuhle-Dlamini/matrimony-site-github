<%-- 
    Document   : search-resultID
    Created on : Oct 4, 2024, 8:37:30 PM
    Author     : dsihl
--%>
...
<html lang="en">
    ...
    <body>
        ...
        <main>
            <section>
                <% if (user != null) { %>
                <p>Showing result for <strong>Member ID</strong> search retrieved 1 results</p>
                <div class="search-result">
                    ...
                    <div class="user-details">
                        ...
                        <div class="member-details">
                            ...
                            <p><a href="tel:+<%= user.getContact_number()%>"><%= user.getContact_number()%></a></p>
