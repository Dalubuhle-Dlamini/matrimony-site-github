<%-- 
    ...
    Created on : Oct 14, 2024, 11:21:59 AM
    Author     : dsihl
--%>
        ...
        <section>
            <div class="login-card">
                <div class="login-card-content">
                    ...
                    <form action="editdetails" method="POST" class="form">

                        <!-- Personal Section -->
                        <fieldset id="personalSection">
                            <legend>Personal Information</legend>
                            <input type="hidden" value="<%= user.getUser_id() %>" name="user_id" id="user_id" >
                            <div class="form-field">
                                <div class="icon">
                                    <i class="fas fa-info-circle"></i>
                                </div>
                                <textarea id="aboutSelf" name="aboutSelf" placeholder="About Self" rows="4"  required>
                                    <%= user.getAboutSelf() %>
                                </textarea>
                            </div>
                            <div class="form-field">
                                ...
                                <textarea id="familyDetails" name="familyDetails" placeholder="Family Details" rows="4" required>
                                    <%= user.getFamilyDetails() %> 
                                </textarea>
                            </div>
                        ...
                        <fieldset id="professionalSection" style="display: none;">
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" id="qualification" name="qualification" value="<%= user.getQualification() %>" placeholder="Qualification" required>
                            </div>
                            <div class="form-field">
                                <div class="icon">
                                    <i class="fas fa-building"></i>
                                </div>
                                <input type="text" id="workingAt" name="workingAt" value="<%= user.getWorkingAt() %>" placeholder="Working At" required>
                            </div>
                            <div class="form-field">
                                <div class="icon">
                                    <i class="fas fa-user-tie"></i>
                                </div>
                                <input type="text" id="designation" name="designation" value="<%= user.getDesignation() %>" placeholder="Designation" required>
                            </div>
                        ...
                        <fieldset id="likingsSection" style="display: none;">
                            ...
                            <div class="form-field">
                                ...
                                <input type="text" id="hobbies" name="hobbies" value="<%= user.getHobbies() %>" placeholder="Hobbies" required>
                            </div>
                            <div class="form-field">
                                <div class="icon">
                                    <i class="fas fa-music"></i>
                                </div>
                                <input type="text" id="favoriteMusic" name="favoriteMusic" value="<%= user.getFavouriteGenre() %>" placeholder="Favorite Genre" required>
                            </div>
                            <div class="form-field">
                                <div class="icon">
                                    <i class="fas fa-film"></i>
                                </div>
                                <input type="text" id="favoriteMovies" name="favoriteMovies" value="<%= user.getFavouriteMovies() %>" placeholder="Favorite Movies" required>
                            </div>
                            <div class="form-field">
                                <div class="icon">
                                    <i class="fas fa-utensils"></i>
                                </div>
                                <input type="text" id="favoriteCuisines" name="favoriteCuisines" value="<%= user.getFavouriteCuisine() %>" placeholder="Favorite Cuisines" required>
                            </div>
                            <div class="form-field">
                                <div class="icon">
                                    <i class="fas fa-book"></i>
                                </div>
                                <input type="text" id="favoriteBooks" name="favoriteBooks" value="<%= user.getFavouriteBooks() %>" placeholder="Favorite Books" required>
                            </div>
                            <div class="form-field">
                                <div class="icon">
                                    <i class="fas fa-globe"></i> 
                                </div>
                                <input type="text" id="favoritePlace" name="favoritePlace" value="<%= user.getFavouritePlaces() %>" placeholder="Favorite Place" required>
                            </div>
