 ...
 * @author dsihl
 */
@WebServlet(name = "InsertAdd", urlPatterns = {"/insert-add"})
public class InsertAdd extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            matrimonySessionBean.insertUserAdd(userId, title, body);
            
            response.sendRedirect("services");
        } catch (SQLException ex) {
            Logger.getLogger(InsertAdd.class.getName()).log(Level.SEVERE, null, ex);
        }
