...
import com.matrinomy.controllers.EditProfile;
 ...
 */
@WebServlet(name = "EditDetailsRoute", urlPatterns = {"/editdetailsroute"})
public class EditDetailsRoute extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("edit-details.jsp").forward(request, response);
