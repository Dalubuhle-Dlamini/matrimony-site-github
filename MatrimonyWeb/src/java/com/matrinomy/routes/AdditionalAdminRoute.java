 ...
 * @author dsihl
 */
@WebServlet(name = "AdditionalAdminRoute", urlPatterns = {"/additional-tables"})
public class AdditionalAdminRoute extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user == null) {
                ...
                request.getRequestDispatcher("additional-admin.jsp").forward(request, response);
            }
