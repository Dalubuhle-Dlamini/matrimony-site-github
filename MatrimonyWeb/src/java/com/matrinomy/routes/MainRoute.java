 ...
 * @author dsihl
 */
@WebServlet(name = "MainRoute", urlPatterns = {"/user", "/home"})
public class MainRoute extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (user == null) {
                ...
                String timeLeft = matrimonySessionBean.getSubscribtionLeft(user.getUser_id());
