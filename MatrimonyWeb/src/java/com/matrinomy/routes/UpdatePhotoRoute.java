 ...
 */
@WebServlet(name = "UpdatePhotoRoute", urlPatterns = {"/updatephotoroute"})
public class UpdatePhotoRoute extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null){
            request.getRequestDispatcher("update-photo.jsp").forward(request,response);
        }else if(user==null){
